    ...
    <div id="templatemo_content">
        ...
        <div id="bookdetails">
        	...
        	<div class="templatemo_product_box">
            	<h1>Diary of Anne Frank <span>(by Anne Frank)</span></h1>
				<img src="images/10.jpg" width="100" height="150">
                <div class="product_info">
                	<p class="bookdetails">The Diary of a Young Girl (also known as The Diary of Anne Frank) is a book of the writings from the Dutch language diary kept by Anne Frank while she was....</p>
					<h3>$32</h3>
                    <div class="detail_button"><a href="10.php">Read more...</a></div>
                </div>
            ...
            <div class="templatemo_product_box">
				...
				<img src="images/3.jpg" width="100" height="150">
                <div class="product_info">
                	<p class="bookdetails">At the conclusion of The Mark of Athena, Annabeth and Percy tumble into a pit leading straight to the Underworld...</p>
					<h3>$30</h3>
                    <div class="detail_button"><a href="3.php">Read more...</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
			...
			<span style="float : left; margin-top:10px; font-size : 14px; font-weight : bold;"><a href="book1.php">Previous</a></span>
			<span style="float : right; margin-top:10px; font-size : 14px; font-weight : bold;"><a href="book3.php">Next</a></span></p>
