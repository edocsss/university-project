		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content">
				...
				<div id="templatemo_content_right">
					...
					<div class="image_panel"><img src="images/7.jpg" width="120" height="200" /></div>
					<ul>
						<li><b>By Lauren Oliver</b></li>
						<li>Publication Date : 28 February 2013</li>
						<li>Pages: 384</li>
						<li>Price : $24</li>
					</ul>
					
					<p>I'm pushing aside the memory of my nightmare, pushing aside thoughts of Alex, pushing aside thoughts of Hana and my old school, push, push, push, like Raven taught me to do. The old life is dead. But the old Lena is dead too. I buried her. I left her beyond a fence, behind a wall of smoke and flame.</p>
					<p>Lauren Oliver delivers an electrifying follow-up to her acclaimed New York Times bestseller, Delirium. This riveting, brilliant novel crackles with the fire of fierce defiance, forbidden romance, and the sparks of a revolution about to ignite.</p>
					<br><br>
					<div id = "add">
