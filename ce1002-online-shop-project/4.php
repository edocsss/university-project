		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content">
				...
				<div id="templatemo_content_right">
					...
					<div class="image_panel"><img src="images/4.jpg" width="120" height="200" /></div>
					<ul>
						<li><b>By Cassandra Clare</b></li>
						<li>Publication Date : 19 March 2013</li>
						<li>Pages: 565</li>
						<li>Price : $25</li>
					</ul>
					
					<p>Danger and betrayal, secrets and enchantment in the breathtaking conclusion to the Infernal Devices trilogy.</p>
					<p>Tessa Gray should be happy - aren't all brides happy? Yet as she prepares for her wedding, a net of shadows begins to tighten around the Shaodwhunters of the London Institute.</p>
					<p>A new demon appears, one linked by blood and secrecy to Mortmain, the man who plans to use his army of pitiless automatons, the Infernal Devices, to destroy the Shadowhunters. Mortmain needs only one last item to complete his plan. He needs Tessa. And Jem and Will, the boys who lay equal claim to Tessa's heart, will do anything to save her.</p>
					<div id = "add">
