    ...
    <div id="templatemo_content">
        ...
        <div id="bookdetails">
        	...
        	<div class="templatemo_product_box">
				...
				<img src="images/5.jpg" width="100" height="150"/>
                <div class="product_info">
                	<p class="bookdetails">One choice can transform you—or it can destroy you. But every choice has consequences, and as unrest surges...</p>
                    <h3>$25</h3>
                    <div class="detail_button"><a href="5.php">Read More...</a></div>
                </div>
            ...
            <div class="templatemo_product_box">
            	<h1>The Hunger Games <span>(by Suzanne Collins)</span></h1>
            	<img src="images/15.jpg" width="100" height="150"/>
                <div class="product_info">
                	<p class="bookdetails">Collins has said that the inspiration for The Hunger Games came from channel surfing on television. On one channel she observed people... </p>
                    <h3>$30</h3>
                    <div class="detail_button"><a href="15.php">Read More...</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
            ...
            <div class="templatemo_product_box">
            	<h1>City of Lost Souls (The Mortal Instruments #5) <span>(by Cassandra Clare)</span></h1>
				<img src="images/6.jpg" width="100" height="150">
                <div class="product_info">
                	<p class="bookdetails">The New York Times bestselling Mortal Instruments continues—and so do the thrills and danger for Jace, Clary, and Simon....</p>
					<h3>$42</h3>
                    <div class="detail_button"><a href="6.php">Read more...</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
           ...
           <div class="templatemo_product_box">
            	<h1>Pride and Prejudice <span>(by Jane Austen)</span></h1>
				<img src="images/9.jpg" width="100" height="150">
                <div class="product_info">
                	<p class="bookdetails">Pride and Prejudice is a novel by Jane Austen, first published in 1813. The story follows the main character Elizabeth Bennet as...</p>
					<h3>$22</h3>
                    <div class="detail_button"><a href="9.php">Read more...</a></div>
            </div>
            <div class="cleaner_with_width">&nbsp;</div>
                <div class="cleaner">&nbsp;</div>
            </div>
			<span style="float : left; margin-top:10px; font-size : 14px; font-weight : bold;"><a href="book3.php">Previous</a></span>
