		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content">
				...
				<div id="templatemo_content_right">
					...
					<div class="image_panel"><img src="images/1.jpg" width="120" height="200" /></div>
					<ul>
						<li><b>By Veronica Roth</b></li>
						<li>Publication Date : 22 October 2013</li>
						<li>Pages: 544</li>
						<li>Price : $25</li>
					</ul>
					...
					<p>Told from a riveting dual perspective, Allegiant, by #1 New York Times best-selling author Veronica Roth, brings the Divergent series to a powerful conclusion while revealing the secrets of the dystopian world that has captivated millions of readers in Divergent and Insurgent</p>
					<div id = "add">
