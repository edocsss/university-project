		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content">
				...
				<div id="templatemo_content_right">
					...
					<div class="image_panel"><img src="images/9.jpg" width="120" height="200" /></div>
					<ul>
						<li><b>By Jane Austen</b></li>
						<li>Publication Date : 12 April 1995</li>
						<li>Pages: 397</li>
						<li>Price : $22</li>
					</ul>
					
					<p>Pride and Prejudice is a novel by Jane Austen, first published in 1813.</p>
					<p>The story follows the main character Elizabeth Bennet as she deals with issues of manners, upbringing, morality, education, and marriage in the society of the landed gentry of early 19th-century England. </p>
					<p>Elizabeth is the second of five daughters of a country gentleman living near the fictional town of Meryton in Hertfordshire, near London.</p>
					<br>
					<div id = "add">
