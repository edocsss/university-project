		...
		<div id="templatemo_container">
			...
			<div id="templatemo_content">
				...
				<div id="templatemo_content_right">
					...
					<div class="image_panel"><img src="images/14.jpg" width="120" height="200" /></div>
					<ul>
						<li><b>By Jeffrey Archer</b></li>
						<li>Publication Date : 30 August 2011</li>
						<li>Pages: 400</li>
						<li>Price : $20</li>
					</ul>
					
					<p>Only Time Will Tell is a first part of the five in Clifton Chronicles by Jeffrey Archer. The book was published worldwide in 2011. It was launched by Jeffrey Archer himself at Bangalore, India in March 2011, as the beginning of a global book tour.</p>
					<p>The plot revolves around the main protagonist Harry Clifton, spanning the time between 1920 and the beginning of the Second World War. The novel is set in Bristol, England, from 1919 to 1940 and centers on Harry Clifton, a young boy destined to follow in the footsteps of his father and uncle and work on the docks until a new world is opened up to him. Harry has the gift of song, and when Miss Monday, the choir mistress, Mr. Holcombe, his elementary school teacher, and Old Jack Tar, a Boer War hero and loner all help him, his life is changed forever. Harry's mother, Maisie, works as a waitress and scrimps and saves to send her son to school and give him a better life.</p>
					<div id = "add">
